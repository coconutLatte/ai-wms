...
| P2-19 | P2 | Service tests for order line, ASN, and inventory status transitions | pending | — | Order line + ASN status transition tests done in P2-18; remaining: inventory status transition tests at service layer |
