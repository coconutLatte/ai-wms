...
## Task: P2-20 — Seed data: create default admin user with hashed password
Hint: —
...
9. Commit & push: git add -A && git commit -m "feat(P1): Seed data: create default admin user with hashed password
