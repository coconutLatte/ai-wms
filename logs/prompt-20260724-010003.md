...
## Task: P3-44 — Shipment domain model + backend: entity, service, API, migration
Hint: —
...
9. Commit & push: git add -A && git commit -m "feat(P1): Shipment domain model + backend: entity, service, API, migration
