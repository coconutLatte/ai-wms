...
## Task: P2-13 — DI wiring: wire TxManager into server startup (cmd/admin, cmd/pda)
Hint: —
...
9. Commit & push: git add -A && git commit -m "feat(P2): DI wiring: wire TxManager into server startup (cmd/admin, cmd/pda)
