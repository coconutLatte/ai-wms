...
## Task: P3-40 — Order cancellation: release reservations + cancel tasks
Hint: —
...
4. Update docs/roadmap.md: change this task status to "completed | 2026-07-23 | <note>"
...
9. Commit & push: git add -A && git commit -m "feat(P1): Order cancellation: release reservations + cancel tasks
