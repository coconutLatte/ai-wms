...
## Task: P1-03 — PostgreSQL repository implementation (SKU + Inventory)
Hint: —
...
6. Commit: git add -A && git commit -m "feat(P1): PostgreSQL repository implementation (SKU + Inventory)
