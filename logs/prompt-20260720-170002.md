...
## Task: P2-03 — Domain unit tests (state machines, business rules)
Hint: —
...
6. Commit & push: git add -A && git commit -m "feat(P1): Domain unit tests (state machines, business rules)
