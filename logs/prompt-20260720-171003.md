...
## Task: P2-04 — Authentication (JWT login, token refresh, middleware)
Hint: —
...
6. Commit & push: git add -A && git commit -m "feat(P1): Authentication (JWT login, token refresh, middleware)
