...
## Task: P2-11 — Tx-aware helpers for remaining repos (warehouse, order, task, user)
Hint: —
...
9. Commit & push: git add -A && git commit -m "feat(P2): Tx-aware helpers for remaining repos (warehouse, order, task, user)
