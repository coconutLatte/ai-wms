...
## Task: P2-19 — Service tests for order line, ASN, and inventory status transitions
Hint: —
...
4. Update docs/roadmap.md: change this task status to "completed | 2026-07-21 | <note>"
...
9. Commit & push: git add -A && git commit -m "feat(P2): Service tests for order line, ASN, and inventory status transitions
