...
## Task: P2-17 — Location status state machine (domain methods + service operations)
Hint: —
...
9. Commit & push: git add -A && git commit -m "feat(P2): Location status state machine (domain methods + service operations)
