...
## Task: P2-15 — AuditLog list endpoint with pagination (service + Admin API)
Hint: —
...
9. Commit & push: git add -A && git commit -m "feat(P2): AuditLog list endpoint with pagination (service + Admin API)
