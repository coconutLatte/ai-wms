...
## Task: P3-17 — REST gap fill: inventory status, order line status, location barcode, SKU barcode
Hint: —
...
4. Update docs/roadmap.md: change this task status to "completed | 2026-07-22 | <note>"
...
9. Commit & push: git add -A && git commit -m "feat(P1): REST gap fill: inventory status, order line status, location barcode, SKU barcode
