...
## Task: P2-16 — User list endpoint with pagination (service + Admin API)
Hint: —
...
9. Commit & push: git add -A && git commit -m "feat(P2): User list endpoint with pagination (service + Admin API)
